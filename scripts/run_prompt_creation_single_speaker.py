...
class DataArguments:
    ...
    speaker_name: str = field(
        metadata={"help": "Speaker name that you want to give to the mono-speaker of your training dataset."},
    )
...
PROMPT = """You will be given four descriptive keywords related to an audio sample of [speaker_name]'s speech. These keywords include:
